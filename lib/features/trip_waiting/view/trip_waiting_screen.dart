...
import '../controller/trip_waiting_controller.dart';
...
class TripWaitingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TripWaitingController>(
      init: TripWaitingController(),
      builder: (controller) {
                    ...
                    child: Column(
                      ...
                      children: [
                        if (isLoading && ride == null)
                          ...
                          Text(
                            'التكلفة التقديرية: ${ride.estimatedFare} ر.س',
                            style: const TextStyle(
                              fontFamily: 'Cairo',
                              fontSize: 14,
                          ...
                          Text(
                            'السائق: ${ride.driverName} • ${ride.driverRating.toStringAsFixed(1)}',
                            style: const TextStyle(
                              fontFamily: 'Cairo',
                              fontSize: 14,
                              color: Color(0xFF1A1A2E),
