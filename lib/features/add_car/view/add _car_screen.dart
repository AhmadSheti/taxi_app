        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text("الخطوة ٢ من ٢", style: TextStyle(color: Colors.teal, fontSize: 14)),
                const SizedBox(height: 4),
                const Text("سيارتك", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
                const SizedBox(height: 8),
                const LinearProgressIndicator(value: 1.0, backgroundColor: Colors.black12, color: Colors.teal),
                  ...
                  child: Container(
                    ...
                    child: _carImage == null
                        ? const Column(
                            ...
                            children: [
                              Icon(Icons.add_a_photo_outlined, size: 44, color: Colors.teal),
                              SizedBox(height: 8),
                              Text("اضغط هنا لإضافة صورة السيارة", style: TextStyle(color: Colors.grey, fontSize: 14)),
                            ],
                          )
                ...
                _buildAnimatedCarField(
                  ...
                  validator: (val) => (val == null || val.trim().isEmpty) ? "الرجاء إدخال رقم اللوحة" : null,
                ),
                ...
                const Align(
                  ...
                  child: Text("نوع السيارة", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.grey)),
                ),
                const SizedBox(height: 8),
                ...
                Row(
                  ...
                  children: ["اقتصادي", "مريح", "فاخر"].map((type) {
                    ...
                    return Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isSelected ? const Color(0xffE0F2F1) : const Color(0xffF7F7F9),
                            borderRadius: BorderRadius.circular(10),
                            border: Border.all(color: isSelected ? Colors.teal : Colors.transparent, width: 1.5),
                          ),
                          child: Center(
                            child: Text(
                              type,
                              style: TextStyle(
                                color: isSelected ? Colors.teal : Colors.black,fontWeight: FontWeight.bold,
                              ),
                            ),
                          ),
                        ),
  ...
  if (_carFormKey.currentState!.validate()) {
    ...
    if (_carImage == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("الرجاء إرفاق صورة للسيارة أولاً"),
          backgroundColor: Colors.red,
        ),
      );
      return; // يوقف الكود هنا إذا الصورة فارغة
    }

    // 3. الانتقال للصفحة (إذا وصل الكود لهنا يعني كل شي تمام)
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>const OtpScreen(),
                    ...
                    child: const Text("إكمال التسجيل", style: TextStyle(fontSize: 18, color: Colors.black, fontWeight: FontWeight.bold)),
                  ),
                ),
